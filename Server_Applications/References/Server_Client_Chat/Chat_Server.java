...
class Server_Input_Thread  extends Thread
{
    ...
    Server_Input_Thread(Socket soc)
    {
        this.soc = soc;
        this.cl = null;
...
class Client_Connection
{
    public BufferedReader cons;
    public DataOutputStream ops;
    public identity id,Server_ID;   
    public Socket soc;
    public Server_Input_Thread inp;

    public Client_Connection(BufferedReader cons,Socket soc,identity Server_id)  
    {
        ...
        try
        {
            ...
            for(int j=0;j<5;j++)
            {
                this.ops.writeUTF("<INFO>"+this.Server_ID.fv.get(this.Server_ID.flds[j])+"<INFO>");
            }
...
public class Chat_Server
{
    ...
    public void Start_Server()
    {
        try
        {
            ...
            temp = servp.accept();
            System.out.println("m");
            Clnts[Clntnum++] = new Client_Connection(cons,temp,this.id);
